...
// AI convergence response - generated by Claude API from structured layer data
const aiTextChunks = [
        ...
        <div className={styles.content}>
          {selectedLayer === 'convergence' && convergenceState === 'converged' ? (
            ...
            <div className={styles.convergenceResult}>
              ...
              {/* Action card appears after all insights */}
              {typingDone && visibleInsights >= aiInsights.length && aiActions.length > 0 && (
                <div className={styles.actionCard}>
                  <div className={styles.actionHeader}>
                    <span className={styles.actionIcon}>⚡</span>
                    <span className={styles.actionTitle}>Recommended Intervention</span>
                  </div>
                  {aiActions.map((a, i) => (
                    <div key={i} className={styles.actionBody}>
                      <div className={styles.actionText}>{a.action}</div>
                      <div className={styles.actionBecause}>
                        <span className={styles.becauseLabel}>Because: </span>
                        {a.because}
                      </div>
                    </div>
                  ))}
